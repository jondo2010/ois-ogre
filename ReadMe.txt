...
This is a modified version of OIS (http://sourceforge.net/projects/wgois/) with the
demos removed, and the autotools-based build system replaced with a CMake-based one.
This work was mostly done by the OGRE team, as part of the ogredeps repository.
